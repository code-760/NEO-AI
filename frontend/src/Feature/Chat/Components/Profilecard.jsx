...
import { useauth } from '../../Auth/hook/userAuth';

export default function Profilecard({ onClose, isOpen, user }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between  gap-9 ">
        <div>
          <span className="text-sm font-medium  text-gray-500 pl-2">{userdata.email}</span>
        </div>
      ...
      <div className="mt-6 flex flex-col items-center">
        ...
        {/* User Name Greeting */}
        <h2 className="mt-3 text-1xl font-medium text-gray-800">{userdata.username}</h2>
      ...
      <div className="mt-5 grid grid-cols-2 gap-2">
        ...
        <Link href="/" className="w-full">
          <button className="flex w-full items-center justify-center active:scale-95 gap-2 rounded-2xl bg-indigo-500 py-3.5 px-3 text-sm font-medium text-white hover:bg-indigo-400 transition-colors">
        ...
        <Link href="/" className="w-full">
          <button
            onClick={logout}
            className="flex w-full items-center justify-center active:scale-95 gap-2 rounded-2xl bg-indigo-500 py-3.5 px-3 text-sm font-medium text-white hover:bg-indigo-400 transition-colors"
          >
